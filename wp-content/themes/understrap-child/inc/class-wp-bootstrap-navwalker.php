...
if ( ! class_exists( 'Understrap_WP_Bootstrap_Navwalker2' ) ) {
	/**
	 * WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class Understrap_WP_Bootstrap_Navwalker2 extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			$title = $item->title /*apply_filters( 'the_title', $item->title, $item->ID )*/;
		 ...
		 *
		 * @return string apply_filters             a string with the openign tag for the element with attribibutes added.
		 */
